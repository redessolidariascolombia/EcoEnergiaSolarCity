...
public class UserRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button botonAdvices = findViewById(R.id.botonAdvices);
        final Intent intent1 = new Intent(this, Login.class);
        final Intent intent2 = new Intent(this, Advice.class);
         ...
         * Botón para Consejos
         */
        botonAdvices.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
