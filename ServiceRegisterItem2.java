...
protected void onCreate(Bundle savedInstanceState) {
    ...
    Button botonRegistrar = findViewById(R.id.btnRegistrarCanchas);
        ...
        public void onClick(View v) {
            ...
            if (!kilovatios.getText().toString().isEmpty() && !precio.getText().toString().isEmpty() && !mes.getText().toString().isEmpty()) {
                ...
                if (mesExiste) {
                    ...
                    Toast.makeText(ServiceRegisterItem2.this, "El mes ya existe", Toast.LENGTH_SHORT).show();
                } else {
                ...
                Toast.makeText(ServiceRegisterItem2.this, "Los campos no pueden estar vacíos", Toast.LENGTH_SHORT).show();
            }
        }
    });
}
    ...
    /**
     * Verifica si un mes existe en el archivo "canchas.txt".
     *
    ...
    /*
     * Guarda los datos en el archivo "canchas.txt" si el mes no existe.
    ...
    public boolean guardarDatos(String kilovatios, String precio, String mes) {
        ...
        try {
            ...
            Canchas canchas = new Canchas(Float.parseFloat(kilovatios), Float.parseFloat(precio), mes);
            String linea = String.format(Locale.getDefault(), "%.2f,%.2f,%s", canchas.getKilovatios(), canchas.getPrecio(), canchas.getMes());
