...
public class ServiceRegisterItem1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button botonRegistrar = findViewById(R.id.btnRegistrarCentros);
        Button botonConsejo = findViewById(R.id.botonAdvices);
        EditText kilovatios = findViewById(R.id.editTextKilovatios);
    ...
    /**
     * Verifica si un mes existe en el archivo "centros.txt".
     *
    ...
    public boolean verificarMes(String mesBuscado) {
        File file = new File(getFilesDir(), "centros.txt");
    ...
    /*
     * Guarda los datos en el archivo "centros.txt" si el mes no existe.
    ...
    public boolean guardarDatos(String kilovatios, String precio, String mes) {
        ...
        try {
            ...
            Centros centros = new Centros(Float.parseFloat(kilovatios), Float.parseFloat(precio), mes);
            String linea = String.format(Locale.getDefault(), "%.2f,%.2f,%s", centros.getKilovatios(), centros.getPrecio(), centros.getMes());
